...
function enhancePlainCodeBlocks() {
  ...
  const plainCodeBlocks = document.querySelectorAll(
...
function enhanceCodeBlocks() {
  ...
  codeBlocks.forEach((block) => {
    ...
    const gutterLines = gutter
      ? Array.from(gutter.querySelectorAll(".line")).map(
...
function enlargeDiagram(diagramElement) {
  ...
  const adjustSize = () => {
    const aspectRatio =
      enlargedDiagram.offsetWidth / enlargedDiagram.offsetHeight;
